...
If you happen to use Calibre to manage books on a regular machine, you can access its library from the e-reader through Wi-Fi.
...
5. Calibre displays a notification when it detects the e-reader, and you can then use the **Send to device** button or context menu to push the desired books to the e-reader.